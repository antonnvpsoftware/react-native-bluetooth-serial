...
public class RCTNioxVeroModule extends ReactContextBaseJavaModule implements ActivityEventListener, LifecycleEventListener {
    ...
    private RCTNioxVeroService mBluetoothService;
    ...
    public RCTNioxVeroModule(ReactApplicationContext reactContext) {
        super(reactContext);
        ...
        if (mBluetoothService == null) {
            mBluetoothService = new RCTNioxVeroService(this);
        }
